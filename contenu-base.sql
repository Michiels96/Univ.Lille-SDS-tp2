...
INSERT INTO `articles` VALUES (1,'Lorem ipsum blah blah');
...
CREATE TABLE `private` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `secretstuff` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `private` VALUES (1,'csupersecret');
...
-- Dump completed on 2021-03-29  9:40:19
